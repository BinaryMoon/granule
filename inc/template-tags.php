 ...
 * @return string
 */
function granule_human_time_diff() {
...
add_filter( 'post_thumbnail_html', 'granule_post_thumbnail_html', 10, 5 );


/**
 * Prints HTML with meta information for the current post-date or time.
 *
 * The time is generated by {@see granule_human_time_diff}.
 */
function granule_post_time() {
 ...
 */
function granule_the_main_category() {
 ...
 */
function granule_project_terms() {
...
?>
	<p class="projects-terms">
		...
		<span class="project-terms-intro">
			<?php esc_html_e( 'Categories:', 'granule' ); ?>
		</span>

		<a class="<?php echo esc_attr( $class ); ?>" href="<?php echo esc_url( home_url( '/portfolio/' ) ); ?>"><?php esc_html_e( 'All', 'granule' ); ?></a>
 ...
 * @return string
 */
function granule_svg( $name, $echo = true ) {
