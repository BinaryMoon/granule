...
;( function( $ ) {
	...
	$( document ).ready( function() {
		...
		$( '.granule-category-checkbox' ).on( 'change', function(){

			var $this = $( this );
			var id = $this.closest( 'li' ).find( '.granule-hidden-categories' ).prop( 'id' );
			var categories = [];

			$this.closest( 'li' ).find( '.granule-category-checkbox' ).each( function() {
		...
		$( '.granule-dragdrop-select' ).on( 'change', function(){
	...
	var list_update = function() {
		...
		$( '.granule-sortable' ).each( function() {
			var list = [];
			var id = $( this ).closest( 'li' ).find( '.granule-hidden-categories' ).prop( 'id' );
	...
	var list_add_close_button = function() {
		...
		$( '.granule-sortable li' ).each(function(){
